% -*- LaTeX -*-
% $Id: Simplify.lhs 2793 2009-04-24 11:54:28Z wlux $
%
...
> simplifyTopDecl _ (DataDecl p tc tvs cs) = return (DataDecl p tc tvs cs)
> simplifyTopDecl _ (NewtypeDecl p tc tvs nc) = return (NewtypeDecl p tc tvs nc)
