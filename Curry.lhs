% -*- LaTeX -*-
% $Id: Curry.lhs 2919 2009-12-02 14:18:15Z wlux $
%
...
>   Int i1 == Int i2 = i1 == i2
>   Int i == Float f = fromInteger i == f
>   Float f == Int i = f == fromInteger i
...
>   fmap f (NegativePattern a op l) = NegativePattern (f a) op l
